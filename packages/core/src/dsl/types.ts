...
export interface OrgInfo {
  ...
  isAutoGeneratedOrganization?: boolean;
  logoUrl?: string;
  createTime?: number;
  contactEmail?: string;
  contactName?: string;
...
export interface CurrentUserResponse {
  ...
  id: string;
  /** Organización activa actualmente (la del workspace seleccionado en la UI) */
  currentOrgId: string;
  /** Email/username de login */
  username: string;
  uiLanguage?: string;
  avatar?: string | null;
  /** Todas las orgs a las que pertenece el usuario, con su rol en cada una */
